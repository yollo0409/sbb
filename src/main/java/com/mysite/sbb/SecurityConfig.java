...
public class SecurityConfig {
	...
	@Bean
	AuthenticationManager autoAuthenticationManager(AuthenticationConfiguration autoAuthenticationConfiguration)
			throws Exception {
		return autoAuthenticationConfiguration.getAuthenticationManager();
	}
}
